...
onMounted(() => {
  ...
  images.value = [snowflake1, snowflake2]
})
</script>
...
You can use this snowfall animation with any framework or even vanilla JS with the `SnowfallCanvas` class, here's an example.
